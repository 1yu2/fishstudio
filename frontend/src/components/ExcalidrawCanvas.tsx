  ...
  ({ canvasId, theme, initialData, onDataChange, onImageToInput, onThemeChange, on3DModelClick, onVideoClick }, ref) => {
    ...
    useEffect(() => {
      ...
      const processMenu = (contextMenu: Element) => {
        ...
        try {
          ;(contextMenu as HTMLElement).classList.add('fishstudio-excalidraw-menu')
        } catch {
          // ignore
        }
        ...
        if (is3DModel && on3DModelClick && linkData) {
          ...
          view3DItem.className = 'context-menu-item fishstudio-context-menu-item'
        ...
        if (onImageToInput) {
          ...
          menuItem.className = 'context-menu-item fishstudio-context-menu-item'
        ...
        const allSeparators = contextMenu.querySelectorAll('hr, [role="separator"], .fishstudio-context-separator')
